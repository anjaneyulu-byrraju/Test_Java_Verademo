								...
								<div>
									...
									<div class="commentText">
										...
										<span class="date sub-text">
											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %><%= ESAPI.encoder().encodeForHTMLAttribute(post.getBlabName()) %>											by <%= post.getAuthor().getBlabName() %> on <%= post.getPostDateString() %>
										</span>
										<br/>
										<span class="date sub-text">
